# Actions on Google - Animal Joker for kids Sample using API.AI

This is a super simple Action, built using API.AI, to generate a (good) animal joke 
based on your favorite animal. This example is built entirely in the API.AI console, 
using just 2 intents and one entity. 
Yes! It got some good jokes in it so give it a try: https://bot.api.ai/animal-joker
...
## Terms
Your use of this sample is subject to, and by using or downloading the sample files you agree to 
comply with, the [Google APIs Terms of Service](https://developers.google.com/terms/).
